	...
	${(props) => {
		if (props.outlined) {
			return `
				...
				border: 2px solid ${props.color || "#ff0000"};
...
export const TwoElementFlexComp = styled.div`
	display: flex;
	justify-content: space-between;
...
export const SearchBarCalendarComp = () => {
	return (
		<TwoElementFlexComp>
			<div>Searchbar</div>
			<div>Calendar</div>
...
export const MiddleHeaderComp = () => {
	return (
		<TwoElementFlexComp>
			<TwoElementFlexComp column>
				<h1>Hello Floyd!</h1>
				<h3>Here is your daily Statistics</h3>
			</TwoElementFlexComp>
			<div>two blocks</div>
		</TwoElementFlexComp>
	);
...
export const ActionCards = ({
	...
	return (
		<Card>
			<TwoElementFlexComp gap={elemGap}>
				<ImgWrapper>
					<Img src={src} />
				</ImgWrapper>
				<TwoElementFlexComp itemAlignment={itemAlignment} column>
					<h3>{msg}</h3>
					<ActionButton
						padding={btnPadding}

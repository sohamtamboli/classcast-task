...
import fitnessImg from "./assets/images/fitnessIsometric.svg";
import noticeImg from "./assets/images/notificationsIsometric.svg";
function App() {
	return (
		<DashboardLayout>
			...
			<>
				<MiddleSectionWrapper>
					<SearchBarCalendarComp />
					<MiddleHeaderComp />
					<TwoElementFlexComp gap={"32px"}>
						<ActionCards
							src={fitnessImg}
							msg={"This is Card One.This is Card One."}
							btnTxt={"More Details"}
							btnColor={"#FF7368"}
							btnPadding={"1rem 1.2rem"}
							btnFontSize={"1.2rem"}
						...
						<ActionCards
							src={noticeImg}
							msg={"This is Card Two.This is Card Two."}
							btnTxt={"Go Pro"}
							btnColor={"#4C95FF"}
							btnPadding={"1rem 1.2rem"}
							btnFontSize={"1.2rem"}
